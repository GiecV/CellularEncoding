...
import torch
import os
from tasks.maze_task import compute_fitness as compute_fitness
...
class Evolution:
    ...
    def __init__(self, population_size: int = 256, generations: int = 300, mutation_rate: float = 0.05, inputs: int = 2, population: list = None):
        """
    ...
    def evolve(self, info: bool = True, stop: bool = True, index = 0):
        ...
        for generation in range(self.generations):
            ...
            state_file = os.path.join(state_folder, f'state_maze_{index}.pkl')
